...
if __name__ == "__main__":
    ...
    # pv.update_config(model_=Model_classic.XGB, descriptor_=Descriptor.WHIM, protein_=DatasetProtein.CLK4)
    # pv.update_paths(correlation_threshold_=0.8, variance=0.95)
    # # main(pv.dfs_descriptors_only_path_,include_files = include_files)
    # # main(pv.dfs_reduced_and_MD_path_,include_files = include_files)
    # main(pv.dfs_dPCA_var_MD_path_,include_files = include_files)
    ...
    # pv.update_config(model_=Model_classic.SVM, descriptor_=Descriptor.WHIM, protein_=DatasetProtein.CLK4)
    # pv.update_paths(correlation_threshold_=0.8, variance=0.95)
    # main(pv.dfs_descriptors_only_path_,include_files = include_files)
    # main(pv.dfs_reduced_and_MD_path_,include_files = include_files)
    # main(pv.dfs_dPCA_var_MD_path_,include_files = include_files)
    ...
    # pv.update_config(model_=Model_classic.RF, descriptor_=Descriptor.GETAWAY, protein_=DatasetProtein.CLK4)
    ...
    # pv.update_config(model_=Model_classic.XGB, descriptor_=Descriptor.GETAWAY, protein_=DatasetProtein.CLK4)
    # include_files = [1,'c10']
    # pv.update_paths(correlation_threshold_=0.7, variance=0.85)
    # main(pv.dfs_descriptors_only_path_,include_files = include_files)
    # include_files = [0,1,'c10']
    ...
    pv.update_config(model_=Model_classic.SVM, descriptor_=Descriptor.GETAWAY, protein_=DatasetProtein.CLK4)
    pv.update_paths(correlation_threshold_=0.7, variance=0.85)
    ...
    # pv.update_config(model_=Model_classic.XGB, descriptor_=Descriptor.WHIM, protein_=DatasetProtein.GSK3)
    # pv.update_paths(correlation_threshold_=0.8, variance=0.95)
    ...
    pv.update_config(model_=Model_classic.XGB, descriptor_=Descriptor.GETAWAY, protein_=DatasetProtein.GSK3)
    pv.update_paths(correlation_threshold_=0.7, variance=0.85)
    main(pv.dfs_descriptors_only_path_,include_files = include_files)
    main(pv.dfs_reduced_and_MD_path_,include_files = include_files)
    main(pv.dfs_reduced_path_,include_files = include_files)
    ...
    pv.update_config(model_=Model_classic.SVM, descriptor_=Descriptor.GETAWAY, protein_=DatasetProtein.GSK3)
    pv.update_paths(correlation_threshold_=0.7, variance=0.85)
    main(pv.dfs_descriptors_only_path_,include_files = include_files)
    main(pv.dfs_reduced_and_MD_path_,include_files = include_files)
    main(pv.dfs_reduced_path_,include_files = include_files)
