...
def save_dataframes(dic_with_dfs, save_path):
...
def main(time_interval = 1, timeinterval_list = [1,0.5,0.2,0.1,0.05,0.02,0.01]):
    ...
    save_dataframes(dfs_in_dict, save_path=pv.dfs_descriptors_only_path_) #automatically save in descriptors_only_folder
